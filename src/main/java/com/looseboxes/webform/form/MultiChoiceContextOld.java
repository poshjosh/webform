 ...
 * @author hp
 */
public class MultiChoiceContextOld extends MultiChoiceContextForJpaEntity{
    
    private static final Logger LOG = LoggerFactory.getLogger(MultiChoiceContextOld.class);
